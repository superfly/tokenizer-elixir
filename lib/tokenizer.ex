defmodule Tokenizer do
  ...
  defmodule Secret do
    defstruct inject_processor: nil, inject_hmac_processor: nil, bearer_auth: nil, macaroon_auth: nil
    ...
    defp merge_processor(%Secret{} = s, %InjectProcessor{} = processor), do: %Secret{s | inject_processor: processor}
    defp merge_processor(%Secret{} = s, %InjectHMACProcessor{} = processor), do: %Secret{s | inject_hmac_processor: processor}
  ...
  defimpl Jason.Encoder, for: [InjectProcessor, InjectHMACProcessor, BearerAuth, MacaroonAuth, Secret] do
